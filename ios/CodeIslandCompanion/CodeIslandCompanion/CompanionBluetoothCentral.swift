...
final class CompanionBluetoothCentral: NSObject, ObservableObject {
    ...
    private static let restoreIdentifier = "com.revopsglobal.codeisland.buddy.bluetooth-central"
    private static let log = Logger(subsystem: "com.revopsglobal.codeisland.buddy", category: "bluetooth-central")
