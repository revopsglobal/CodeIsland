...
private struct MascotsPage: View {
    ...
    private let mascotList: [(name: String, source: String, desc: String, color: Color)] = [
        ("Sheldon", "claude", "Claude Code", Color(red: 0.36, green: 0.72, blue: 0.25)),
    ...
    var body: some View {
        Form {
            ...
            Section("Telegram fallback") {
                ...
                Text("Optional personal backup for when APNs or Live Activities miss you. It only sends redacted approval/question alerts, a Buddy deep link, and your private Tailscale web link; the actual decision still happens in Buddy or the CodeIsland web app.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
